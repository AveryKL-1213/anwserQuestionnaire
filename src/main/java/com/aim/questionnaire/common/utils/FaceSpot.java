...
//百度API自己创建的应用的参数
    private static final String AppID = "24384411";
    private static final String APIKey = "Ohsmnn3O5bp4Pu4vAvSoC9hL";
    private static final String SecretKey = "Yp4PtvhprcvL5GtC5Okmf8IXcMVhfLt2";
